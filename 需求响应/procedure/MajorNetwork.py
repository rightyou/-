...
from 需求响应.procedure.show import double_var
...
class MAJOR():
    def __init__(self, DATA):
        ...
        self.T = int(DATA['T'])
        self.distr_UP = np.ones((self.DistributionNetwork_num, DATA['T'])) * 500
        self.distr_LO = np.zeros((self.DistributionNetwork_num, DATA['T']))
